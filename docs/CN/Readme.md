...
## 要求
JetCache 2.8+需要JDK17以上版本、Spring Framework 6.x以上版本、Spring Boot 3.x以上版本。如果不使用注解（仅使用jetcache-core），Spring Framework也是可选的，此时使用方式与Guava/Caffeine cache类似。2.7及以下版本支持JDK8+，具体参见[版本兼容性说明](Compatibility.md)。
